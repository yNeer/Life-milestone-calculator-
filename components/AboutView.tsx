...
const AboutView: React.FC = () => {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="bg-skin-card/70 backdrop-blur-xl rounded-2xl shadow-sm border border-white/20 overflow-hidden">
            <div className="bg-gradient-to-r from-skin-primary to-blue-600 h-32 relative">
                <div className="absolute inset-0 bg-black/10"></div>
                <div className="absolute -bottom-10 left-8">
                     <div className="w-24 h-24 bg-skin-card rounded-full p-1 shadow-lg backdrop-blur-sm bg-opacity-80">
                        <div className="w-full h-full rounded-full bg-skin-input flex items-center justify-center text-3xl font-bold text-skin-primary border-2 border-skin-border/20">
                            itN
                        </div>
                     </div>
                </div>
            ...
            <div className="pt-12 px-8 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <a href="https://github.com/yNeer" target="_blank" rel="noopener noreferrer" 
                       className="flex items-center gap-4 p-4 rounded-xl border border-skin-border/50 bg-skin-input/50 hover:bg-skin-input hover:border-skin-primary/30 transition-all group backdrop-blur-sm">
                ...
                <h3 className="text-lg font-bold text-skin-text mb-4 border-b border-skin-border/50 pb-2">Ventures & Projects</h3>
                <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-skin-base/50 border border-skin-border/50 backdrop-blur-sm">
